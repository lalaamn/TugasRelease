          ...
          Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [Color.fromARGB(255, 137, 35, 127), Color.fromARGB(255, 190, 74, 165)], // Gradien warna biru
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const CircleAvatar(
                  radius: 100,
                  backgroundImage: AssetImage("assets/images/poto-mala.jpg"), // Path to your profile picture
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        InkWell(
                          onTap: () => _launchURL('tel:+62895412295400'),
                          child: Row(
                        ...
                        const SizedBox(height: 10),
                        InkWell(
                          onTap: () => _launchURL('mailto:2106042@itg.ac.id'),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: const [
